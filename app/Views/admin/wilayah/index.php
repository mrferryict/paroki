...
<div class="space-y-6">
    <div class="flex flex-wrap items-center justify-between gap-3">
        <div>
            <h1 class="font-display text-3xl font-semibold text-maroon">Wilayah</h1>
            <p class="mt-1 text-sm text-stone-600">Kelola wilayah paroki beserta ketua wilayah.</p>
        </div>
    ...
    <div class="grid gap-6 lg:grid-cols-5">
        <section class="lg:col-span-3">
            <?= view('admin/wilayah/partials/list', ['items' => $items]) ?>
        </section>
        <section class="lg:col-span-2">
            <div id="wilayah-form-panel" class="rounded-lg border border-gold/20 bg-white p-4 shadow-sm">
                <p class="text-sm text-stone-500">Pilih wilayah untuk diedit, atau klik <strong>Tambah Wilayah</strong>.</p>
            </div>
        </section>
    </div>
</div>

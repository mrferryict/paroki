...
<div class="space-y-6">
    <div class="flex flex-wrap items-center justify-between gap-3">
        <div>
            <h1 class="font-display text-3xl font-semibold text-maroon">Unduhan</h1>
        ...
        <button type="button" class="rounded bg-maroon px-4 py-2 text-sm font-medium text-ivory hover:bg-maroon/90"
                hx-get="<?= site_url('admin/dokumen/new') ?>" hx-target="#dokumen-form-panel" hx-swap="innerHTML">+ Tambah Unduhan</button>
    </div>
    ...
    <div class="grid gap-6 lg:grid-cols-5">
        <section class="lg:col-span-3">
            <?= view('admin/dokumen/partials/list', [
                'items'           => $items,
        ...
        <section class="lg:col-span-2">
            <div id="dokumen-form-panel" class="rounded-lg border border-gold/20 bg-white p-4 shadow-sm">
                <p class="text-sm text-stone-500">Pilih unduhan untuk diedit, atau klik <strong>Tambah Unduhan</strong>.</p>
            </div>
        </section>
    </div>
</div>

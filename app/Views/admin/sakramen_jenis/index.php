...
<div class="space-y-6">
    <div class="flex flex-wrap items-center justify-between gap-3">
        <div>
            <h1 class="font-display text-3xl font-semibold text-maroon">Layanan Paroki</h1>
            <p class="mt-1 text-sm text-stone-600">Kelola jenis layanan formulir paroki (sakramen, konsultasi, administrasi, petugas).</p>
        </div>
    ...
    <div class="grid gap-6 lg:grid-cols-5">
        <section class="lg:col-span-3">
            <?= view('admin/sakramen_jenis/partials/list', ['items' => $items, 'kodeOptions' => $kodeOptions, 'grupOptions' => $grupOptions]) ?>
        </section>

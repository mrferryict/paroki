...
$icons = [
    ...
    'imamat' => '<svg viewBox="0 0 24 24" ' . $iconAttrs . '><path d="M12 2l2 5h5l-4 3 1.5 5L12 13l-4.5 2L9 10 5 7h5z"/><path d="M8 21h8"/></svg>',
    'pemazmur' => '<svg viewBox="0 0 24 24" ' . $iconAttrs . '><path d="M9 18V5l12-2v13"/><circle cx="6" cy="18" r="3"/></svg>',
    'prodiakon' => '<svg viewBox="0 0 24 24" ' . $iconAttrs . '><path d="M12 3v18M7 8h10M7 12h10M7 16h6"/></svg>',
    'organis' => '<svg viewBox="0 0 24 24" ' . $iconAttrs . '><rect x="4" y="8" width="16" height="10" rx="1"/><path d="M8 8V5h8v3M6 18v2M18 18v2"/></svg>',
